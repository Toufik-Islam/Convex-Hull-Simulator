 ...
 */
 ...
 public class JarvisMarch extends ConvexHullAlgorithm{
     ...
     public JarvisMarch(Point[] points)
     {
         ...
         isStart = false;
         leftmostInd = 0;
         totalComparator = 0; // Reset the counter for each new instance
     ...
     private void updateLeftmost(int i) {
         totalComparator++; // Count comparison for X coordinates
     ...
     private void nextStep(AnimationArea animationArea) {
         ...
         totalComparator++; // Count comparison for direction check
